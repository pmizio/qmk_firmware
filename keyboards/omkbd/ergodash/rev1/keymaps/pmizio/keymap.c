...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    XXXXXXX, GUI_A,   ALT_S,   CTL_D,    SFT_F,   KC_G,    XXXXXXX,                        XXXXXXX,    KC_H,     SFT_J,   CTL_K,   ALT_L,    GUI_SCLN,KC_QUOT,
    XXXXXXX, KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,            XXXXXXX,        XXXXXXX,            KC_N,     KC_M,    KC_COMM, KC_DOT,   KC_SLSH, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           LOWER,   KC_SPC, KC_BSPC,        XXXXXXX,KC_ENT,     RAISE,             XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX
  ),
   ...
   */
  [_LOWER] = LAYOUT(
    KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,                          KC_F12,  KC_F6,   KC_F8,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  [_RAISE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, FARROW,  TARROW,  XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, KC_EQL,  KC_UNDS, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX,          XXXXXXX,       XXXXXXX,          XXXXXXX, KC_PLUS, KC_MINS, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, XXXXXXX,          _______, _______, _______,       XXXXXXX, _______, _______,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_ADJUST] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, BL_TOGG, BL_INC,  BL_DEC,  XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          OS,          XXXXXXX,          XXXXXXX, GAMING,  QWERTY,  XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  )
};
